        ...
        if ((count nearBuyableVehicles)-1 >= _forEachIndex) then {
            ...
            if !(_sPos isEqualTo []) then {
                ...
                if (cursorObject == _veh) then {
                    ...
                    _x ctrlSetStructuredText parseText ("<t align='center'><t size='1.5'>" + _name + "</t><br/><t color='#ff0000'>For Sale!</t></t>");
                    _x ctrlSetFade .5;
                };
                _x ctrlCommit 0;
                _x ctrlShow true;
            ...
            if !(_sPos isEqualTo []) then {
                ...
                if (cursorObject == _gun) then {
                    if ((_gun distance player) < 5) then {
                        _x ctrlSetStructuredText parseText ("<t align='center'><t size='1.5'>" + _name + "</t><br/><t color='#ff0000'>For Sale!</t><br/><t color='#00ff00'>$" + str _price + "</t><br/>Press [Win] to <t color='#00ff00'>BUY WEAPON</t><br/>Press [E] to <t color='#00ff00'>BUY AMMO</t></t>");
                        _x ctrlSetFade 0;
                    } else {
                        _x ctrlSetStructuredText parseText ("<t align='center'><t size='1.5'>" + _name + "</t><br/><t color='#ff0000'>For Sale!</t><br/><t color='#00ff00'>$" + str _price + "</t></t>");
                        _x ctrlSetFade 0;
